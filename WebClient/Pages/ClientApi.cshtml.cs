...
{
	public class ClientApiModel : PageModel
	{
		private readonly ILogger<UserApiModel> _logger;
        IHttpClientFactory _factory;
        public string content { get; private set; }
        public ClientApiModel(ILogger<UserApiModel> logger, IHttpClientFactory factory)
		{
			_logger = logger;
            _factory = factory;
        }
        ...
        {
            using (var client = _factory.CreateClient("weather_client"))
            {
